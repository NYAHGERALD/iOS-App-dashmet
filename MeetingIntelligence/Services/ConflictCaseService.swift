...
struct ConflictCaseAPIData: Codable {
    ...
    let employeeGeneratedDocuments: String?   // Per-employee generated documents JSON
    let approvedEmployeeNames: String?        // JSON array of approved employee names
...
struct ConflictDocumentAPIData: Codable {
    let id: String
    let type: String
    let createdAt: String  // Backend sends createdAt, not uploadedAt
    let updatedAt: String?
